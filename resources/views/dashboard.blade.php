        ...
        <div class="col-lg-12">
          <div class="row">
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="my-auto">
                      <h4 class="fw-bolder mb-0">{{$shareds}}</h4>
                      <span class="text-success small pt-1 fw-bold">{{round($porcentajeShareds)}}%</span>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Time Remaining | <span>(days)</span></h5>
                  <!--  -->
                  <div class="d-flex flex-row">
                    <div class="avatar bg-light-primary me-2 p-1">
                      <div class="avatar-content fs-2">
                          <i class="bi bi-hourglass-split"></i>
                      </div>
                    </div>
                    <div class="my-auto">
                      <h4 class="fw-bolder mb-0">{{$time}} Days</h4>
                      <p class="card-text font-small-3 mb-0">increase (Daily)</p>
                    </div>
                  </div>
                  <!--  -->
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="my-auto">
                      ...
                      <span class="text-success small pt-1 fw-bold">{{round($porcentajeRaised)}}%</span>
                      <p class="card-text font-small-3 mb-0">increase (Daily)</p>
                    </div>
                  </div>
                  <!--  -->
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="my-auto">
                      ...
                      <span class="text-success small pt-1 fw-bold">{{round($porcentajeDonors)}}%</span>
                      <p class="card-text font-small-3 mb-0">increase (Daily)</p>
                    </div>
                  </div>
                  <!--  -->
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <div class="my-auto">
                      <h4 class="fw-bolder mb-0">{{$puntos}}</h4>
                      <span class="text-success small pt-1 fw-bold"><a href="{{route('generaltable')}}">See</a></span>
                      <p class="card-text font-small-3 mb-0">increase (Daily)</p>
                    </div>
                  </div>
                  <!--  -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card mb-4 py-0 text-center border" id="description">
              <div class="card-body py-3">
                  <h6 class="h6 d-inline font-weight-bold mx-auto">{{url('/event')}}/{{$evento->slug}}</h6> <br class="d-sm-block d-md-none">
                  <a href="{{url('/event')}}/{{$evento->slug}}" target="_blank" class="btn btn-outline-warning round mx-auto">Go Event</a>
                  <x-shared-popover-button :evento="$evento"/>
                  <a wire:click='borrar()' class="btn btn-outline-warning round text-danger mx-auto">Borrar</a>
              </div>
            </div>
