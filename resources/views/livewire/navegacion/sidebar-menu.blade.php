<div id="sidebar" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <a class="navbar-brand" target="_blank" href="{{ route('welcome') }}"> 
              <span class="brand-logo">
                <svg
                  id="Capa_1"
                  data-name="Capa 1"
                  viewBox="0 0 536.65001 626.08001"
                  version="1.1"
              ...
              <h6 class="brand-text text-truncate font-small-4 text-warning">CB FUNDRAISING</h6>
            </a>
          </li>
  ...
  <div class="main-menu-content">
    ...
    @role('admin')  
      <li class="nav-item">
        <a class="d-flex align-items-center {{ request()->routeIs('adminDashboard') ? 'active' : 'collapsed' }}" href="{{ route('adminDashboard') }}">
          <i data-feather="home"></i>
          <span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span>
        </a>
      </li><!-- End Dashboard Nav -->

      <li class="nav-item {{request()->routeIs('adminEventdata') ? 'open' : ''}} {{request()->routeIs('adminStopevent') ? 'open' : ''}}">
        <a class="d-flex align-items-center">
          <i data-feather="calendar"></i>
          <span class="menu-title text-truncate" data-i18n="calendar">Events</span>
        </a>
        <ul class="menu-content">
            <li>
              <a class="d-flex align-items-center {{ request()->routeIs('adminEventdata') ? 'active' : '' }}" href="{{ route('adminEventdata') }}">
                <i data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="Events data">Events data</span>
              </a>
              <a class="d-flex align-items-center {{ request()->routeIs('adminStopevent') ? 'active' : '' }}" href="{{ route('adminStopevent') }}">
                <i data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="Stop event">Stop event</span>
              </a>
            </li>
        </ul>
      </li>

      <li class="nav-item {{request()->routeIs('adminGeneraltable') ? 'open' : ''}} {{request()->routeIs('adminPartnertable') ? 'open' : ''}}">
        <a class="d-flex align-items-center">
          <i data-feather="user-check"></i>
          <span class="menu-title text-truncate" data-i18n="calendar">Administrators data</span>
        </a>
        <ul class="menu-content">
            <li>
              <a class="d-flex align-items-center {{ request()->routeIs('adminGeneraltable') ? 'active' : '' }}" href="{{ route('adminGeneraltable') }}">
                <i data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="General Table">General Table</span>
              </a>
              <a class="d-flex align-items-center {{ request()->routeIs('adminPartnertable') ? 'active' : '' }}" href="{{ route('adminPartnertable') }}">
                <i data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="Partner Table">Partner Table</span>
              </a>
            </li>
        </ul>
      </li>
    ...
    @role('org')
        <li class="nav-item">
          <a class="d-flex align-items-center {{ request()->routeIs('dashboard') ? 'active' : 'collapsed' }}" href="{{ route('dashboard') }}">
            <i data-feather="home"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span>
          </a>
        </li><!-- End Dashboard Nav -->

        <li class="nav-item {{request()->routeIs('editevent') ? 'open' : ''}}">
          <a class="d-flex align-items-center">
            <i data-feather="calendar"></i>
            <span class="menu-title text-truncate" data-i18n="calendar">Event</span>
          </a>
          <ul class="menu-content">
              <li>
                <a class="d-flex align-items-center {{ request()->routeIs('editevent') ? 'active' : '' }}" href="{{ route('editevent') }}">
                  <i data-feather="circle"></i>
                  <span class="menu-item text-truncate" data-i18n="Analytics">Event Edit</span>
                </a>
              </li>
          </ul>
        </li>

        <li class="nav-item {{request()->routeIs('generaltable') ? 'open' : ''}}">
          <a class="d-flex align-items-center">
            <i data-feather="check-square"></i>
            <span class="menu-title text-truncate" data-i18n="analytics">Your Points</span>
          </a>
          <ul class="menu-content">
              <li>
                <a class="d-flex align-items-center {{ request()->routeIs('generaltable') ? 'active' : '' }}" href="{{ route('generaltable') }}">
                  <i data-feather="circle"></i>
                  <span class="menu-item text-truncate" data-i18n="Analytics">General Table</span>
                </a>
              </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          <a class="d-flex align-items-center {{ request()->routeIs('profile.show') ? 'active' : 'collapsed' }}" href="{{ route('profile.show') }}">
            <i data-feather="user-check"></i>
        ...
        <li class="nav-item">
          <a class="d-flex align-items-center {{ request()->routeIs('faq') ? 'active' : 'collapsed' }}" href="{{ route('faq') }}">
            <i data-feather="shield"></i>
            <span class="menu-title text-truncate" data-i18n="FAQ">F.A.Q CB Fundraising</span>
          </a>
